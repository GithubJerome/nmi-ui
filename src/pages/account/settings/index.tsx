...
import { Dispatch, connect, useIntl, FormattedMessage } from 'umi';
...
type SettingsStateKeys = 'base' | 'security' | 'binding' | 'notification' | 'email';
...
class Settings extends Component<SettingsProps, SettingsState> {
  ...
  constructor(props: SettingsProps) {
    ...
    const menuMap = {
      base: <FormattedMessage
        id="pages.account.settings.base.basic"
  ...
  renderChildren = () => {
    ...
    switch (selectKey) {
      case 'base':
        return <ProfileView props={this.props} />;
      case 'security':
        return <SecurityView />;
      case 'binding':
        return <BindingView />;

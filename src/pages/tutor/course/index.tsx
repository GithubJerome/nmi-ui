...
const TutorCoursePage: React.FC<{}> = () => {
  ...
  const queryTutorCourseDetails = (params: { course_id: string; limit : number; page : number; }) => {
    ...
    request
      ...
      .then((response) => {
        console.log("queryTutorCourseDetails response.children == ", response.children[0]);
  ...
  const downloadCourseUpdate = () => {
    ...
    request
      ...
      .then((response) => {
        console.log("downloadCourseUpdate response.data == ", response.location);
        setLoading(false);
      ...
      <React.Fragment>
        ...
        <Row gutter={24} type="flex">
                  ...
                  <Col sm={22} xs={24} style={{ textAlign: "left" }} >
                    <Row gutter={24} type="flex">
                      <Col sm={24} xs={24} style={{ textAlign: "left" }} >
                        <Typography>
                          <Title level={3}>
                            {tutorCourseDetails.course_name}
                          </Title>
                        </Typography>
                      </Col>
                    </Row>
          ...
          <Col sm={24} xs={24} style={{ marginBottom: 24 }}>
            {console.log("results/overview === ", tutorCourseDetails)}
            <Card bordered={false}>
              <Table
